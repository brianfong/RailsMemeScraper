...
class MemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post memes_url, params: { meme: { author: @meme.author, name: @meme.name, permalink: @meme.permalink, text: @meme.text, title: @meme.title, url: @meme.url } }
    end
  ...
  test "should update meme" do
    patch meme_url(@meme), params: { meme: { author: @meme.author, name: @meme.name, permalink: @meme.permalink, text: @meme.text, title: @meme.title, url: @meme.url } }
